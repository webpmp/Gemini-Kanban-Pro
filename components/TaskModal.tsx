    ...
    <div className="fixed inset-0 bg-black/70 flex justify-center items-center z-50 overflow-y-auto p-4 backdrop-blur-sm transition-opacity">
      <div className="bg-slate-900 rounded-xl shadow-2xl w-full max-w-3xl flex flex-col max-h-[90vh] animate-in fade-in zoom-in duration-200 border border-slate-800 text-slate-100">
        ...
        <div className="p-6 overflow-y-auto flex-1 space-y-6">
            ...
            <div className="space-y-5">
              <div>
                ...
                <div className="relative">
                    ...
                    className="w-full pl-9 p-2.5 bg-slate-800 border border-slate-700 rounded-lg hover:bg-slate-750 focus:bg-slate-800 focus:ring-2 focus:ring-primary-500 outline-none transition-all text-sm appearance-none text-white"
                    >
            ...
            <div className="space-y-5">
               <div>
                 ...
                 <select
                    ...
                    className="w-full p-2.5 bg-slate-800 border border-slate-700 rounded-lg text-sm mb-2 outline-none focus:ring-2 focus:ring-primary-500 text-white"
                 >
                     {Object.values(TaskStatus).map(s => <option key={s} value={s}>{s}</option>)}
                 </select>
                 <input
                    type="text"
                    placeholder="Custom status detail (e.g. 'Pending Review')"
               ...
               <div className="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <input 
                            ...
                            className="w-full p-2.5 bg-slate-800 border border-slate-700 rounded-lg text-sm outline-none focus:ring-2 focus:ring-primary-500 text-white [color-scheme:dark]"
                        />
                    </div>
                    <div>
          ...
          {/* Meta Grid Bottom Section - Split to enforce alignment of Dependencies and Tags */}
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
             ...
             {/* Right Column - Bottom */}
             <div className="space-y-4">
                 {/* Tags - Added mt-1 for vertical alignment fix */}
               <div className="mt-1">
